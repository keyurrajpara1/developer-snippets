...
return [
    ...
    */
    ...
    'password' => [
        'mixedCase' => 'Το :attribute πρέπει να περιέχει τόσο κεφαλαία όσο και πεζά γράμματα.',
        'numbers' => 'Το :attribute πρέπει να περιέχει τουλάχιστον έναν αριθμό.',
        'symbols' => 'Το :attribute πρέπει να περιέχει τουλάχιστον ένα σύμβολο, π.χ. !, @, #, $, κ.λπ.',
        'uncompromised' => 'Το :attribute εντοπίστηκε σε γνωστή παραβίαση δεδομένων. Επιλέξτε διαφορετικό κωδικό πρόσβασης.',
    ],
    ...
    */
    'custom' => [
        ...
        'full_name' => [
            'space_required' => 'Το πλήρες όνομα πρέπει να περιέχει τουλάχιστον ένα όνομα και ένα επώνυμο, χωρισμένα με κενό.',
        ],
        'gdpr_consent' => [
            'required' => 'Πρέπει να λάβετε τη συγκατάθεση του πελάτη πριν προχωρήσετε.',
        ],
        'prepayment_required' => [
            'required' => 'Πρέπει να καθορίσετε εάν απαιτείται προπληρωμή.',
        ],
        'start_before_end' => 'Η ώρα έναρξης πρέπει να είναι πριν από την ώρα λήξης για :day.',
        'end_date' => [
            'start_before_end' => 'Η ημερομηνία και ώρα λήξης πρέπει να είναι μετά την ημερομηνία και ώρα έναρξης.',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
